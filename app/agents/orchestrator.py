...
REGLA DE CLARIFICACIÓN: Si el contexto previo muestra que el bot hizo una pregunta de aclaración sobre fechas, año o franquicia ("¿A qué año te referís?", "¿Para cuál franquicia?"), y el mensaje del usuario es una respuesta corta ("2025", "el año pasado", "la 1", "la primera", "la segunda", "ambas"), clasificar como "data" o "comparative" según el tipo de consulta original en el contexto.
REGLA DE FRANQUICIA: Si el mensaje cuestiona o pregunta sobre la franquicia de la respuesta anterior ("¿sobre qué franquicia?", "¿de cuál franquicia son esos datos?", "¿qué franquicia usaste?"), clasificar como "data" para que el sistema pueda aclarar y re-ejecutar con la franquicia correcta.
